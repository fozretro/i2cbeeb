...
mos_scratch = &A8		\MOS star-command scratch (#12, JGH-style); +0..+2 for Configure TempSpace
comdata	=	mos_scratch+3	\Y save during command parsing
temp1	=	mos_scratch+4	\command transient temporary #1
temp2	=	mos_scratch+5	\command transient temporary #2
